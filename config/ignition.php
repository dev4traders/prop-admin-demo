...
return [
    ...
    */
    ...
    'remote_sites_path' => env('IGNITION_REMOTE_SITES_PATH', '/var/www/html/funded'),
    'local_sites_path' => env('IGNITION_LOCAL_SITES_PATH', '\\wsl.localhost\Ubuntu\var\www\html\funded'),
